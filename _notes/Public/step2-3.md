...
$$
\begin{aligned}
d {\theta _i} _{,approx} &:= \frac{J (\theta _1, \theta _2, \cdots, \theta _i + \epsilon, \cdots, \theta _n) - J (\theta _1, \theta _2, \cdots, \theta _i - \epsilon, \cdots, \theta _n)}{2\epsilon} \\
&\approx \frac{\partial J}{\partial \theta _i}
\end{aligned}
$$
...
$$
\frac{ {\lVert d \theta _{approx} - d \theta \rVert} }
{ {\lVert d \theta {approx} \rVert} + {\lVert d \theta \rVert} }
$$
...
> [이전 포스트](https://sol1archive.github.io/note/step2-2) |  [다음 포스트](https://sol1archive.github.io/note/step2-4)
